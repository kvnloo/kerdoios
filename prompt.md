...
1. Clone or open https://github.com/kvnloo/kerdoios. `cd` into that tree. `git fetch origin`. Branch from `origin/main` unless the issue names another base.
...
8. Open a PR on https://github.com/kvnloo/kerdoios with `.github/PULL_REQUEST_TEMPLATE.md` filled. Bind evidence to `head_revision`. **Do not merge.**
